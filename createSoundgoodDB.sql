...
ALTER TABLE student_instrument_skill_level ADD CONSTRAINT PK_student_instrument_skill_level PRIMARY KEY (student_id,instrument_type);
...
CREATE TABLE ensemble_time_slot (
 ensemble_id INT NOT NULL,
 time_slot_id INT NOT NULL
);

ALTER TABLE ensemble_time_slot ADD CONSTRAINT PK_ensemble_time_slot PRIMARY KEY (ensemble_id,time_slot_id);
...
CREATE TABLE group_lesson_time_slot (
 group_lesson_id INT NOT NULL,
 time_slot_id INT NOT NULL
);

ALTER TABLE group_lesson_time_slot ADD CONSTRAINT PK_group_lesson_time_slot PRIMARY KEY (group_lesson_id,time_slot_id);
...
ALTER TABLE student_instrument_skill_level ADD CONSTRAINT FK_student_instrument_skill_level_0 FOREIGN KEY (student_id) REFERENCES student (id);
ALTER TABLE student_instrument_skill_level ADD CONSTRAINT FK_student_instrument_skill_level_1 FOREIGN KEY (instrument_type) REFERENCES instrument_type (instrument_type);


ALTER TABLE emergency_contact ADD CONSTRAINT FK_emergency_contact_0 FOREIGN KEY (student_id) REFERENCES student (id);


ALTER TABLE instructor ADD CONSTRAINT FK_instructor_0 FOREIGN KEY (person_id) REFERENCES person (id);


ALTER TABLE instructor_instrument_type ADD CONSTRAINT FK_instructor_instrument_type_0 FOREIGN KEY (instructor_id) REFERENCES instructor (id);
ALTER TABLE instructor_instrument_type ADD CONSTRAINT FK_instructor_instrument_type_1 FOREIGN KEY (instrument_type) REFERENCES instrument_type (instrument_type);


ALTER TABLE private_lesson ADD CONSTRAINT FK_private_lesson_0 FOREIGN KEY (student_id) REFERENCES student (id);
ALTER TABLE private_lesson ADD CONSTRAINT FK_private_lesson_1 FOREIGN KEY (instructor_id) REFERENCES instructor (id);
...
ALTER TABLE rental ADD CONSTRAINT FK_rental_1 FOREIGN KEY (physical_instrument_id) REFERENCES physical_instrument (id);
...
ALTER TABLE ensemble_instrument_type ADD CONSTRAINT FK_ensemble_instrument_type_0 FOREIGN KEY (instrument_type) REFERENCES instrument_type (instrument_type);
ALTER TABLE ensemble_instrument_type ADD CONSTRAINT FK_ensemble_instrument_type_1 FOREIGN KEY (ensemble_id) REFERENCES ensemble (id);


ALTER TABLE ensemble_student ADD CONSTRAINT FK_ensemble_student_0 FOREIGN KEY (student_id) REFERENCES student (id);
ALTER TABLE ensemble_student ADD CONSTRAINT FK_ensemble_student_1 FOREIGN KEY (ensemble_id) REFERENCES ensemble (id);


ALTER TABLE ensemble_time_slot ADD CONSTRAINT FK_ensemble_time_slot_0 FOREIGN KEY (ensemble_id) REFERENCES ensemble (id);
ALTER TABLE ensemble_time_slot ADD CONSTRAINT FK_ensemble_time_slot_1 FOREIGN KEY (time_slot_id) REFERENCES time_slot (id);
...
ALTER TABLE group_lesson_student ADD CONSTRAINT FK_group_lesson_student_0 FOREIGN KEY (student_id) REFERENCES student (id);
ALTER TABLE group_lesson_student ADD CONSTRAINT FK_group_lesson_student_1 FOREIGN KEY (group_lesson_id) REFERENCES group_lesson (id);


ALTER TABLE group_lesson_time_slot ADD CONSTRAINT FK_group_lesson_time_slot_0 FOREIGN KEY (group_lesson_id) REFERENCES group_lesson (id);
ALTER TABLE group_lesson_time_slot ADD CONSTRAINT FK_group_lesson_time_slot_1 FOREIGN KEY (time_slot_id) REFERENCES time_slot (id);
